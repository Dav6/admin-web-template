<!--
  ...
  @FilePath: src\components\pages\404\components\common.vue  
  @LastEditTime: ''
  @LastEditors: ''
  @Description: 
        do.....
...
const goTo = () => {
  ...
  // console.log(router.options.routes.find(item=>item.isMainRoute))

  // let _route = router.getRoutes().find(item=>item.isMainRoute);
