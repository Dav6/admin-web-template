/**
    ...
    @FilePath:  src\views\mms\material\materialUpload\components\treeDialog\store\index.ts
    @LastEditTime:  ''
    @LastEditors:  ''
    @Description:  do.....
*/
...
const treeDialog = 'materialUploadTreeDialog'
import {
...
export const useTreeDialogStore = defineStore({
  ...
  actions: {
    ...
    addData(data: any) {
      ...
      // this.APIStore.setDataAPI(createDataAPI, _data, '', this.treeDialogData, this.materialUploadStore.getList).then((res: any) => {
      //   // console.log('res',res);
      // })
    },
