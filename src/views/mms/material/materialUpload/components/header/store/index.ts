/**
    ...
    @FilePath:  src\views\mms\material\materialUpload\components\header\store\index.ts
    @LastEditTime:  ''
    @LastEditors:  ''
    @Description:  do.....
*/
...
const header: string = 'materialUploadHeader'
// import {} from "../api";
    ...
    actions: {
        ...
        setListQuery(key: string) {
            ...
            if (_key == "reset") {
                ...
                // materialUploadStore.$resetState();
                // 清空 直接查询列表
            ...
            this.materialUploadStore.getList(true)
        },
        ...
        openDialog(key: string, data: any) {
            ...
            if(key === 'tree'){
                this.materialUploadStore.treeDialogStore.openCloseDialog(true,'add',_data)
            }

            if(key === 'addEdit'){
                this.materialUploadStore.addEditDialogStore.openCloseDialog(true,'add',_data)
            }
