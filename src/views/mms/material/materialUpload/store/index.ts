/**
    ...
    @FilePath:  src\views\mms\material\materialUpload\store\index.ts
    @LastEditTime:  ''
    @LastEditors:  ''
    @Description:  do.....
*/
...
export const useMaterialUploadStore = defineStore({
    ...
    actions: {
        ...
        onPageSizeChange(data: any) {
            ...
            // materialUploadStore.getList(true);
            this.getList(true)
        },
...
//components 里的 store 都挂在 主 useMaterialUploadStore 里
setStoresShare(useMaterialUploadStore, componentsStoreFiles);