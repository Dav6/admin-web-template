<!--
    ...
    @FilePath:  src\views\mms\material\materialList\components\header\index.vue
    @LastEditTime:  ''
    @LastEditors:  ''
    @Description:  do.....
-->
...
const goTo = (key: string, data?: any) => {
  ...
  if (_key == "add") {
    // materialListStore.addEditDialogData.isShow = true;
    // materialListStore.addEditDialogData.type = "add";
