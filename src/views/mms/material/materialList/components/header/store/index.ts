/**
    ...
    @FilePath:  src\views\mms\material\materialList\components\header\store\index.ts
    @LastEditTime:  ''
    @LastEditors:  ''
    @Description:  do.....
*/
...
const header: string = 'materialListHeader'
// import {} from "../api";
...
export const useHeaderStore = defineStore({
    ...
    actions: {
        ...
        setListQuery(key: string) {
            ...
            this.materialListStore.getList(true)
        },
        ...
        openDialog(key: string, data: any) {
            ...
            if(key === 'tree'){
                this.materialListStore.treeDialogStore.openCloseDialog(true,'add',_data)
            }

            if(key === 'addEdit'){
                this.materialListStore.addEditDialogStore.openCloseDialog(true,'add',_data)
            }
