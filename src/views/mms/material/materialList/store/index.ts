/**
    ...
    @FilePath:  src\views\mms\material\materialList\store\index.ts
    @LastEditTime:  ''
    @LastEditors:  ''
    @Description:  do.....
*/
...
// id 命名为 materialList
export const useMaterialListStore = defineStore({
    ...
    actions: {
        ...
        onPageSizeChange(data: any) {
            ...
            // materialListStore.getList(true);
            this.getList(true)
        },
...
//components 里的 store 都挂在 主 useMaterialListStore 里
setStoresShare(useMaterialListStore, componentsStoreFiles);