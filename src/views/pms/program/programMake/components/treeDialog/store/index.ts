/**
    ...
    @FilePath:  src\views\pms\program\programMake\components\treeDialog\store\index.ts
    @LastEditTime:  ''
    @LastEditors:  ''
    @Description:  do.....
*/
...
const treeDialog = 'programMakeTreeDialog'
import {
...
export const useTreeDialogStore = defineStore({
  ...
  actions: {
    ...
    addData(data: any) {
      ...
      // this.APIStore.setDataAPI(createDataAPI, _data, '', this.treeDialogData, this.programMakeStore.getList).then((res: any) => {
      //   // console.log('res',res);
      // })
    },
