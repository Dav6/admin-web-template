<!--
    ...
    @FilePath:  src\views\pms\program\programMake\components\header\index.vue
    @LastEditTime:  ''
    @LastEditors:  ''
    @Description:  do.....
-->
...
const goTo = (key: string, data?: any) => {
  ...
  if (_key == "add") {
    // programMakeStore.addEditDialogData.isShow = true;
    // programMakeStore.addEditDialogData.type = "add";
