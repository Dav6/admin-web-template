/**
    ...
    @FilePath:  src\views\pms\program\programMake\components\header\store\index.ts
    @LastEditTime:  ''
    @LastEditors:  ''
    @Description:  do.....
*/
...
const header: string = 'programMakeHeader'
// import {} from "../api";
...
export const useHeaderStore = defineStore({
    ...
    actions: {
        ...
        setListQuery(key: string) {
            ...
            this.programMakeStore.getList(true)
        },
        ...
        openDialog(key: string, data: any) {
            ...
            if(key === 'tree'){
                this.programMakeStore.treeDialogStore.openCloseDialog(true,'add',_data)
            }

            if(key === 'addEdit'){
                this.programMakeStore.addEditDialogStore.openCloseDialog(true,'add',_data)
            }
