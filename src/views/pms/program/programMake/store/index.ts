/**
    ...
    @FilePath:  src\views\pms\program\programMake\store\index.ts
    @LastEditTime:  ''
    @LastEditors:  ''
    @Description:  do.....
*/
...
// id 命名为 programMake
export const useProgramMakeStore = defineStore({
...
//components 里的 store 都挂在 主 useProgramMakeStore 里
setStoresShare(useProgramMakeStore, componentsStoreFiles);