<!--
    ...
    @FilePath:  src\views\pms\program\programList\components\header\index.vue
    @LastEditTime:  ''
    @LastEditors:  ''
    @Description:  do.....
-->
...
const goTo = (key: string, data?: any) => {
  ...
  if (_key == "add") {
    // programListStore.addEditDialogData.isShow = true;
    // programListStore.addEditDialogData.type = "add";
