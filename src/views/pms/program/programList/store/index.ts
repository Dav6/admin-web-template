/**
    ...
    @FilePath:  src\views\pms\program\programList\store\index.ts
    @LastEditTime:  ''
    @LastEditors:  ''
    @Description:  do.....
*/
...
// id 命名为 programList
export const useProgramListStore = defineStore({
...
//components 里的 store 都挂在 主 useProgramListStore 里
setStoresShare(useProgramListStore, componentsStoreFiles);