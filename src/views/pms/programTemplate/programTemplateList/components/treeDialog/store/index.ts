/**
    ...
    @FilePath:  src\views\pms\programTemplate\programTemplateList\components\treeDialog\store\index.ts
    @LastEditTime:  ''
    @LastEditors:  ''
    @Description:  do.....
*/
...
const treeDialog = 'programTemplateListTreeDialog'
import {
...
export const useTreeDialogStore = defineStore({
  ...
  actions: {
    ...
    addData(data: any) {
      ...
      // this.APIStore.setDataAPI(createDataAPI, _data, '', this.treeDialogData, this.programTemplateListStore.getList).then((res: any) => {
      //   // console.log('res',res);
      // })
    },
