/**
    ...
    @FilePath:  src\views\pms\programTemplate\programTemplateList\components\header\store\index.ts
    @LastEditTime:  ''
    @LastEditors:  ''
    @Description:  do.....
*/
...
const header: string = 'programTemplateListHeader'
// import {} from "../api";
    ...
    actions: {
        ...
        setListQuery(key: string) {
            ...
            if (_key == "reset") {
                ...
                // programTemplateListStore.$resetState();
                // 清空 直接查询列表
            ...
            this.programTemplateListStore.getList(true)
        },
        ...
        openDialog(key: string, data: any) {
            ...
            if(key === 'tree'){
                this.programTemplateListStore.treeDialogStore.openCloseDialog(true,'add',_data)
            }

            if(key === 'addEdit'){
                this.programTemplateListStore.addEditDialogStore.openCloseDialog(true,'add',_data)
            }
