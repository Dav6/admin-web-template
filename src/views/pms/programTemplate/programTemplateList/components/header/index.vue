<!--
    ...
    @FilePath:  src\views\pms\programTemplate\programTemplateList\components\header\index.vue
    @LastEditTime:  ''
    @LastEditors:  ''
    @Description:  do.....
-->
...
const goTo = (key: string, data?: any) => {
  ...
  if (_key == "add") {
    // programTemplateListStore.addEditDialogData.isShow = true;
    // programTemplateListStore.addEditDialogData.type = "add";
