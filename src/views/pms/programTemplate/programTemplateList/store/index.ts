/**
    ...
    @FilePath:  src\views\pms\programTemplate\programTemplateList\store\index.ts
    @LastEditTime:  ''
    @LastEditors:  ''
    @Description:  do.....
*/
...
export const useProgramTemplateListStore = defineStore({
    // id: 必须的，在所有 Store 中唯一
    id: "programTemplateList",
    // state: 返回对象的函数
    state: () => ({
        pageConfig: {
            title: "节目模板",
    ...
    actions: {
        ...
        onPageSizeChange(data: any) {
            ...
            // programTemplateListStore.getList(true);
            this.getList(true)
        },
...
//components 里的 store 都挂在 主 useProgramTemplateListStore 里
setStoresShare(useProgramTemplateListStore, componentsStoreFiles);