/**
    ...
    @FilePath:  src\views\pms\programTemplate\programTemplateMake\store\index.ts
    @LastEditTime:  ''
    @LastEditors:  ''
    @Description:  do.....
*/
...
export const useProgramTemplateMakeStore = defineStore({
    // id: 必须的，在所有 Store 中唯一
    id: "programTemplateMake",
    // state: 返回对象的函数
    state: () => ({
        pageConfig: {
            title: "模板制作",
    ...
    actions: {
        ...
        onPageSizeChange(data: any) {
            ...
            // programTemplateMakeStore.getList(true);
            this.getList(true)
        },
...
//components 里的 store 都挂在 主 useProgramTemplateMakeStore 里
setStoresShare(useProgramTemplateMakeStore, componentsStoreFiles);