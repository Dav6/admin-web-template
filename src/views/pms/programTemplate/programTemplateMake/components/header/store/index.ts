/**
    ...
    @FilePath:  src\views\pms\programTemplate\programTemplateMake\components\header\store\index.ts
    @LastEditTime:  ''
    @LastEditors:  ''
    @Description:  do.....
*/
...
const header: string = 'programTemplateMakeHeader'
// import {} from "../api";
    ...
    actions: {
        ...
        setListQuery(key: string) {
            ...
            if (_key == "reset") {
                ...
                // programTemplateMakeStore.$resetState();
                // 清空 直接查询列表
            ...
            this.programTemplateMakeStore.getList(true)
        },
        ...
        openDialog(key: string, data: any) {
            ...
            if(key === 'tree'){
                this.programTemplateMakeStore.treeDialogStore.openCloseDialog(true,'add',_data)
            }

            if(key === 'addEdit'){
                this.programTemplateMakeStore.addEditDialogStore.openCloseDialog(true,'add',_data)
            }
