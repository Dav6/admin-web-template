<!--
    ...
    @FilePath:  src\views\pms\programTemplate\programTemplateMake\components\header\index.vue
    @LastEditTime:  ''
    @LastEditors:  ''
    @Description:  do.....
-->
...
const goTo = (key: string, data?: any) => {
  ...
  if (_key == "add") {
    // programTemplateMakeStore.addEditDialogData.isShow = true;
    // programTemplateMakeStore.addEditDialogData.type = "add";
