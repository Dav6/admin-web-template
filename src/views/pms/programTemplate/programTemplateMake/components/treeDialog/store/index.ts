/**
    ...
    @FilePath:  src\views\pms\programTemplate\programTemplateMake\components\treeDialog\store\index.ts
    @LastEditTime:  ''
    @LastEditors:  ''
    @Description:  do.....
*/
...
const treeDialog = 'programTemplateMakeTreeDialog'
import {
...
export const useTreeDialogStore = defineStore({
  ...
  actions: {
    ...
    addData(data: any) {
      ...
      // this.APIStore.setDataAPI(createDataAPI, _data, '', this.treeDialogData, this.programTemplateMakeStore.getList).then((res: any) => {
      //   // console.log('res',res);
      // })
    },
