/**
    ...
    @FilePath:  src\views\dms\device\deviceVolume\components\treeDialog\store\index.ts
    @LastEditTime:  ''
    @LastEditors:  ''
    @Description:  do.....
*/
...
const treeDialog = 'deviceVolumeTreeDialog'
import {
...
export const useTreeDialogStore = defineStore({
  ...
  actions: {
    ...
    addData(data: any) {
      ...
      // this.APIStore.setDataAPI(createDataAPI, _data, '', this.treeDialogData, this.deviceVolumeStore.getList).then((res: any) => {
      //   // console.log('res',res);
      // })
    },
