<!--
    ...
    @FilePath:  src\views\dms\device\deviceVolume\components\header\index.vue
    @LastEditTime:  ''
    @LastEditors:  ''
    @Description:  do.....
-->
...
const goTo = (key: string, data?: any) => {
  ...
  if (_key == "add") {
    // deviceVolumeStore.addEditDialogData.isShow = true;
    // deviceVolumeStore.addEditDialogData.type = "add";
