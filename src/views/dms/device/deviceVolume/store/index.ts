/**
    ...
    @FilePath:  src\views\dms\device\deviceVolume\store\index.ts
    @LastEditTime:  ''
    @LastEditors:  ''
    @Description:  do.....
*/
...
// id 命名为 deviceVolume
export const useDeviceVolumeStore = defineStore({
    ...
    actions: {
        ...
        onPageSizeChange(data: any) {
            ...
            // deviceVolumeStore.getList(true);
            this.getList(true)
        },
...
//components 里的 store 都挂在 主 useDeviceVolumeStore 里
setStoresShare(useDeviceVolumeStore, componentsStoreFiles);