/**
    ...
    @FilePath:  src\views\dms\device\deviceEdit\store\index.ts
    @LastEditTime:  ''
    @LastEditors:  ''
    @Description:  do.....
*/
...
// id 命名为 deviceEdit
export const useDeviceEditStore = defineStore({
...
//components 里的 store 都挂在 主 useDeviceEditStore 里
setStoresShare(useDeviceEditStore, componentsStoreFiles);