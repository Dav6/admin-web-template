<!--
    ...
    @FilePath:  src\views\dms\device\deviceSchedule\components\header\index.vue
    @LastEditTime:  ''
    @LastEditors:  ''
    @Description:  do.....
-->
...
const goTo = (key: string, data?: any) => {
  ...
  if (_key == "add") {
    // deviceScheduleStore.addEditDialogData.isShow = true;
    // deviceScheduleStore.addEditDialogData.type = "add";
