/**
    ...
    @FilePath:  src\views\dms\device\deviceSchedule\components\header\store\index.ts
    @LastEditTime:  ''
    @LastEditors:  ''
    @Description:  do.....
*/
...
const header: string = 'deviceScheduleHeader'
// import {} from "../api";
    ...
    actions: {
        ...
        setListQuery(key: string) {
            ...
            if (_key == "reset") {
                ...
                // deviceScheduleStore.$resetState();
                // 清空 直接查询列表
            ...
            this.deviceScheduleStore.getList(true)
        },
        ...
        openDialog(key: string, data: any) {
            ...
            if(key === 'tree'){
                this.deviceScheduleStore.treeDialogStore.openCloseDialog(true,'add',_data)
            }

            if(key === 'addEdit'){
                this.deviceScheduleStore.addEditDialogStore.openCloseDialog(true,'add',_data)
            }
