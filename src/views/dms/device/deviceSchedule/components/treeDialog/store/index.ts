/**
    ...
    @FilePath:  src\views\dms\device\deviceSchedule\components\treeDialog\store\index.ts
    @LastEditTime:  ''
    @LastEditors:  ''
    @Description:  do.....
*/
...
const treeDialog = 'deviceScheduleTreeDialog'
import {
...
export const useTreeDialogStore = defineStore({
  ...
  actions: {
    ...
    addData(data: any) {
      ...
      // this.APIStore.setDataAPI(createDataAPI, _data, '', this.treeDialogData, this.deviceScheduleStore.getList).then((res: any) => {
      //   // console.log('res',res);
      // })
    },
