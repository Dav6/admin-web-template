/**
    ...
    @FilePath:  src\views\dms\device\deviceSchedule\store\index.ts
    @LastEditTime:  ''
    @LastEditors:  ''
    @Description:  do.....
*/
...
export const useDeviceScheduleStore = defineStore({
    ...
    actions: {
        ...
        onPageSizeChange(data: any) {
            ...
            // deviceScheduleStore.getList(true);
            this.getList(true)
        },
...
//components 里的 store 都挂在 主 useDeviceScheduleStore 里
setStoresShare(useDeviceScheduleStore, componentsStoreFiles);