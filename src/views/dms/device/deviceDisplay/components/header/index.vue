<!--
    ...
    @FilePath:  src\views\dms\device\deviceDisplay\components\header\index.vue
    @LastEditTime:  ''
    @LastEditors:  ''
    @Description:  do.....
-->
...
const goTo = (key: string, data?: any) => {
  ...
  if (_key == "add") {
    // deviceDisplayStore.addEditDialogData.isShow = true;
    // deviceDisplayStore.addEditDialogData.type = "add";
