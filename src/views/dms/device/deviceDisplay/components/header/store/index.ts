/**
    ...
    @FilePath:  src\views\dms\device\deviceDisplay\components\header\store\index.ts
    @LastEditTime:  ''
    @LastEditors:  ''
    @Description:  do.....
*/
...
const header: string = 'deviceDisplayHeader'
// import {} from "../api";
...
export const useHeaderStore = defineStore({
    ...
    actions: {
        ...
        setListQuery(key: string) {
            ...
            this.deviceDisplayStore.getList(true)
        },
        ...
        openDialog(key: string, data: any) {
            ...
            if(key === 'tree'){
                this.deviceDisplayStore.treeDialogStore.openCloseDialog(true,'add',_data)
            }

            if(key === 'addEdit'){
                this.deviceDisplayStore.addEditDialogStore.openCloseDialog(true,'add',_data)
            }
