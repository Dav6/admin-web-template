/**
    ...
    @FilePath:  src\views\dms\device\deviceDisplay\components\treeDialog\store\index.ts
    @LastEditTime:  ''
    @LastEditors:  ''
    @Description:  do.....
*/
...
const treeDialog = 'deviceDisplayTreeDialog'
import {
...
export const useTreeDialogStore = defineStore({
  ...
  actions: {
    ...
    addData(data: any) {
      ...
      // this.APIStore.setDataAPI(createDataAPI, _data, '', this.treeDialogData, this.deviceDisplayStore.getList).then((res: any) => {
      //   // console.log('res',res);
      // })
    },
