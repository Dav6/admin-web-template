/**
    ...
    @FilePath:  src\views\dms\device\deviceDisplay\store\index.ts
    @LastEditTime:  ''
    @LastEditors:  ''
    @Description:  do.....
*/
...
export const useDeviceDisplayStore = defineStore({
    ...
    actions: {
        ...
        onPageSizeChange(data: any) {
            ...
            // deviceDisplayStore.getList(true);
            this.getList(true)
        },
...
//components 里的 store 都挂在 主 useDeviceDisplayStore 里
setStoresShare(useDeviceDisplayStore, componentsStoreFiles);