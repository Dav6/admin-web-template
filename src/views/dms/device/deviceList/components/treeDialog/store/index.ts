/**
    ...
    @FilePath:  src\views\dms\device\deviceList\components\treeDialog\store\index.ts
    @LastEditTime:  ''
    @LastEditors:  ''
    @Description:  do.....
*/
...
const treeDialog = 'deviceListTreeDialog'
import {
...
export const useTreeDialogStore = defineStore({
  ...
  actions: {
    ...
    addData(data: any) {
      ...
      // this.APIStore.setDataAPI(createDataAPI, _data, '', this.treeDialogData, this.deviceListStore.getList).then((res: any) => {
      //   // console.log('res',res);
      // })
    },
