<!--
    ...
    @FilePath:  src\views\dms\device\deviceList\components\header\index.vue
    @LastEditTime:  ''
    @LastEditors:  ''
    @Description:  do.....
-->
...
const goTo = (key: string, data?: any) => {
  ...
  if (_key == "add") {
    // deviceListStore.addEditDialogData.isShow = true;
    // deviceListStore.addEditDialogData.type = "add";
