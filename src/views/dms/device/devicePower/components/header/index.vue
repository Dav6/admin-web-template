<!--
    ...
    @FilePath:  src\views\dms\device\devicePower\components\header\index.vue
    @LastEditTime:  ''
    @LastEditors:  ''
    @Description:  do.....
-->
...
const goTo = (key: string, data?: any) => {
  ...
  if (_key == "add") {
    // devicePowerStore.addEditDialogData.isShow = true;
    // devicePowerStore.addEditDialogData.type = "add";
