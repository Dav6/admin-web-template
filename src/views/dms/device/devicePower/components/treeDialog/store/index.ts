/**
    ...
    @FilePath:  src\views\dms\device\devicePower\components\treeDialog\store\index.ts
    @LastEditTime:  ''
    @LastEditors:  ''
    @Description:  do.....
*/
...
const treeDialog = 'devicePowerTreeDialog'
import {
...
export const useTreeDialogStore = defineStore({
  ...
  actions: {
    ...
    addData(data: any) {
      ...
      // this.APIStore.setDataAPI(createDataAPI, _data, '', this.treeDialogData, this.devicePowerStore.getList).then((res: any) => {
      //   // console.log('res',res);
      // })
    },
