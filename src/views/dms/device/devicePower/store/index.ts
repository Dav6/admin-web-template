/**
    ...
    @FilePath:  src\views\dms\device\devicePower\store\index.ts
    @LastEditTime:  ''
    @LastEditors:  ''
    @Description:  do.....
*/
...
// id 命名为 devicePower
export const useDevicePowerStore = defineStore({
...
//components 里的 store 都挂在 主 useDevicePowerStore 里
setStoresShare(useDevicePowerStore, componentsStoreFiles);