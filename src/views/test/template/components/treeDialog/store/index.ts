/*
  ...
  @FilePath: src\views\tms\test\components\treeDialog\store\index.ts  
  @LastEditTime: ''
  @LastEditors: ''
  @Description: 
        do.....
...
const treeDialog = 'XXXTreeDialog'
import {
...
export const useTreeDialogStore = defineStore({
  ...
  actions: {
    ...
    addData(data: any) {
      ...
      // this.APIStore.setDataAPI(createDataAPI, _data, '', this.treeDialogData, this.XXXStore.getList).then((res: any) => {
      //   // console.log('res',res);
      // })
    },
