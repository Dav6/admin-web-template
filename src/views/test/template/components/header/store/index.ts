/*
  ...
  @FilePath: src\views\tms\test\components\header\store\index.ts
  @LastEditTime: ''
  @LastEditors: ''
  @Description:
        do.....
...
export const useHeaderStore = defineStore({
    ...
    actions: {
        ...
        openDialog(key: string, data: any) {
            ...
            if(key === 'tree'){
                this.XXXStore.treeDialogStore.openCloseDialog(true,'add',_data)
            }

            if(key === 'addEdit'){
                this.XXXStore.addEditDialogStore.openCloseDialog(true,'add',_data)
            }
