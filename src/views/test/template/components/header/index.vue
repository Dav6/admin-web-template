<!--
  @Author: 戴伟
  @Date: 2023-04-12 11:02:02
  @FilePath: src\views\system\test\components\containerTop\index.vue
  @LastEditTime: ''
  @LastEditors: ''
  @Description:
        do.....
...
const goTo = (key: string, data?: any) => {
  ...
  if (_key == "add") {
    // XXXStore.addEditDialogData.isShow = true;
    // XXXStore.addEditDialogData.type = "add";
