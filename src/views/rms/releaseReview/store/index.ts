/**
    ...
    @FilePath:  src\views\rms\releaseReview\store\index.ts
    @LastEditTime:  ''
    @LastEditors:  ''
    @Description:  do.....
*/
...
export const useReleaseReviewStore = defineStore({
    ...
    actions: {
        ...
        onPageSizeChange(data: any) {
            ...
            // releaseReviewStore.getList(true);
            this.getList(true)
        },
...
//components 里的 store 都挂在 主 useReleaseReviewStore 里
setStoresShare(useReleaseReviewStore, componentsStoreFiles);