<!--
    ...
    @FilePath:  src\views\rms\releaseReview\components\header\index.vue
    @LastEditTime:  ''
    @LastEditors:  ''
    @Description:  do.....
-->
...
const goTo = (key: string, data?: any) => {
  ...
  if (_key == "add") {
    // releaseReviewStore.addEditDialogData.isShow = true;
    // releaseReviewStore.addEditDialogData.type = "add";
