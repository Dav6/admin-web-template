/**
    ...
    @FilePath:  src\views\rms\releaseReview\components\header\store\index.ts
    @LastEditTime:  ''
    @LastEditors:  ''
    @Description:  do.....
*/
...
const header: string = 'releaseReviewHeader'
// import {} from "../api";
...
export const useHeaderStore = defineStore({
    ...
    actions: {
        ...
        setListQuery(key: string) {
            ...
            this.releaseReviewStore.getList(true)
        },
        ...
        openDialog(key: string, data: any) {
            ...
            if(key === 'tree'){
                this.releaseReviewStore.treeDialogStore.openCloseDialog(true,'add',_data)
            }

            if(key === 'addEdit'){
                this.releaseReviewStore.addEditDialogStore.openCloseDialog(true,'add',_data)
            }
