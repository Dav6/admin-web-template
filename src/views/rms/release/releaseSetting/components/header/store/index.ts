/**
    ...
    @FilePath:  src\views\rms\release\releaseSetting\components\header\store\index.ts
    @LastEditTime:  ''
    @LastEditors:  ''
    @Description:  do.....
*/
...
const header: string = 'releaseSettingHeader'
// import {} from "../api";
    ...
    actions: {
        ...
        setListQuery(key: string) {
            ...
            if (_key == "reset") {
                ...
                // releaseSettingStore.$resetState();
                // 清空 直接查询列表
            ...
            this.releaseSettingStore.getList(true)
        },
        ...
        openDialog(key: string, data: any) {
            ...
            if(key === 'tree'){
                this.releaseSettingStore.treeDialogStore.openCloseDialog(true,'add',_data)
            }

            if(key === 'addEdit'){
                this.releaseSettingStore.addEditDialogStore.openCloseDialog(true,'add',_data)
            }
