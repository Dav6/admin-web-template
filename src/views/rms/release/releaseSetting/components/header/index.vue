<!--
    ...
    @FilePath:  src\views\rms\release\releaseSetting\components\header\index.vue
    @LastEditTime:  ''
    @LastEditors:  ''
    @Description:  do.....
-->
...
const goTo = (key: string, data?: any) => {
  ...
  if (_key == "add") {
    // releaseSettingStore.addEditDialogData.isShow = true;
    // releaseSettingStore.addEditDialogData.type = "add";
