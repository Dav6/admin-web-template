/**
    ...
    @FilePath:  src\views\rms\release\releaseSetting\components\treeDialog\store\index.ts
    @LastEditTime:  ''
    @LastEditors:  ''
    @Description:  do.....
*/
...
const treeDialog = 'releaseSettingTreeDialog'
import {
...
export const useTreeDialogStore = defineStore({
  ...
  actions: {
    ...
    addData(data: any) {
      ...
      // this.APIStore.setDataAPI(createDataAPI, _data, '', this.treeDialogData, this.releaseSettingStore.getList).then((res: any) => {
      //   // console.log('res',res);
      // })
    },
