/**
    ...
    @FilePath:  src\views\rms\release\releaseSetting\store\index.ts
    @LastEditTime:  ''
    @LastEditors:  ''
    @Description:  do.....
*/
...
export const useReleaseSettingStore = defineStore({
    ...
    actions: {
        ...
        onPageSizeChange(data: any) {
            ...
            // releaseSettingStore.getList(true);
            this.getList(true)
        },
...
//components 里的 store 都挂在 主 useReleaseSettingStore 里
setStoresShare(useReleaseSettingStore, componentsStoreFiles);