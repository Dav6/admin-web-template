/**
    ...
    @FilePath:  src\views\rms\release\releaseList\store\index.ts
    @LastEditTime:  ''
    @LastEditors:  ''
    @Description:  do.....
*/
...
// id 命名为 releaseList
export const useReleaseListStore = defineStore({
...
//components 里的 store 都挂在 主 useReleaseListStore 里
setStoresShare(useReleaseListStore, componentsStoreFiles);