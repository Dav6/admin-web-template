/**
    ...
    @FilePath:  src\views\rms\release\releaseList\components\header\store\index.ts
    @LastEditTime:  ''
    @LastEditors:  ''
    @Description:  do.....
*/
...
const header: string = 'releaseListHeader'
// import {} from "../api";
...
export const useHeaderStore = defineStore({
    ...
    actions: {
        ...
        setListQuery(key: string) {
            ...
            this.releaseListStore.getList(true)
        },
        ...
        openDialog(key: string, data: any) {
            ...
            if(key === 'tree'){
                this.releaseListStore.treeDialogStore.openCloseDialog(true,'add',_data)
            }

            if(key === 'addEdit'){
                this.releaseListStore.addEditDialogStore.openCloseDialog(true,'add',_data)
            }
