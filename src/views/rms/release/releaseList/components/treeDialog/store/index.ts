/**
    ...
    @FilePath:  src\views\rms\release\releaseList\components\treeDialog\store\index.ts
    @LastEditTime:  ''
    @LastEditors:  ''
    @Description:  do.....
*/
...
const treeDialog = 'releaseListTreeDialog'
import {
...
export const useTreeDialogStore = defineStore({
  ...
  actions: {
    ...
    addData(data: any) {
      ...
      // this.APIStore.setDataAPI(createDataAPI, _data, '', this.treeDialogData, this.releaseListStore.getList).then((res: any) => {
      //   // console.log('res',res);
      // })
    },
