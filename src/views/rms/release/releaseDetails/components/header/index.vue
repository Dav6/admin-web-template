<!--
    ...
    @FilePath:  src\views\rms\release\releaseDetails\components\header\index.vue
    @LastEditTime:  ''
    @LastEditors:  ''
    @Description:  do.....
-->
...
const goTo = (key: string, data?: any) => {
  ...
  if (_key == "add") {
    // releaseDetailsStore.addEditDialogData.isShow = true;
    // releaseDetailsStore.addEditDialogData.type = "add";
