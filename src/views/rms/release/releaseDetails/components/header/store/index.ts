/**
    ...
    @FilePath:  src\views\rms\release\releaseDetails\components\header\store\index.ts
    @LastEditTime:  ''
    @LastEditors:  ''
    @Description:  do.....
*/
...
const header: string = 'releaseDetailsHeader'
// import {} from "../api";
    ...
    actions: {
        ...
        setListQuery(key: string) {
            ...
            if (_key == "reset") {
                ...
                // releaseDetailsStore.$resetState();
                // 清空 直接查询列表
            ...
            this.releaseDetailsStore.getList(true)
        },
        ...
        openDialog(key: string, data: any) {
            ...
            if(key === 'tree'){
                this.releaseDetailsStore.treeDialogStore.openCloseDialog(true,'add',_data)
            }

            if(key === 'addEdit'){
                this.releaseDetailsStore.addEditDialogStore.openCloseDialog(true,'add',_data)
            }
