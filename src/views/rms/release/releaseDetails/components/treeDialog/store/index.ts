/**
    ...
    @FilePath:  src\views\rms\release\releaseDetails\components\treeDialog\store\index.ts
    @LastEditTime:  ''
    @LastEditors:  ''
    @Description:  do.....
*/
...
const treeDialog = 'releaseDetailsTreeDialog'
import {
...
export const useTreeDialogStore = defineStore({
  ...
  actions: {
    ...
    addData(data: any) {
      ...
      // this.APIStore.setDataAPI(createDataAPI, _data, '', this.treeDialogData, this.releaseDetailsStore.getList).then((res: any) => {
      //   // console.log('res',res);
      // })
    },
