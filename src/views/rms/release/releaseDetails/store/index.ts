/**
    ...
    @FilePath:  src\views\rms\release\releaseDetails\store\index.ts
    @LastEditTime:  ''
    @LastEditors:  ''
    @Description:  do.....
*/
...
export const useReleaseDetailsStore = defineStore({
    ...
    actions: {
        ...
        onPageSizeChange(data: any) {
            ...
            // releaseDetailsStore.getList(true);
            this.getList(true)
        },
...
//components 里的 store 都挂在 主 useReleaseDetailsStore 里
setStoresShare(useReleaseDetailsStore, componentsStoreFiles);